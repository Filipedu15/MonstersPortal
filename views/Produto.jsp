...
<!--------------------------------------	IMAGEM	--------------------------------------->
				<p align="center">
				  <a href="<c:url value="/Produtos/${ produto.nome_produto }"/>" title="${ produto.nome_produto }">
...
<!--------------------------------------	NOME	--------------------------------------->
					<h4 class="nome_produto" title="${ produto.nome_produto }">
					  <a href="<c:url value="/Produtos/${ produto.nome_produto }"/>">${ fn:substring(produto.nome_produto,0,30) } ...<br>
