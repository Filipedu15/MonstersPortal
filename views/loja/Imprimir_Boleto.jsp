...
<body>
	<div class="custom">
		...
		<b>Total da Fatura: <fmt:formatNumber value="${ pedido.preco_pedido }" type="currency"/></b><!-------------------------------OK---------------------------------------- Valor	-->
		<br /><br /><hr />
	</div>
	<div class="mestre">
	...
	<table class="tab rec">
	  ...
	  <tr>
		<td>Valor do Documento<br /><span class="vV"><fmt:formatNumber value="${ pedido.preco_pedido }" type="currency"/></span></td><!--------OK--------------------------------- Valor	-->
	...
	<table class="infRec">
	  <tr>
		...
		<td colspan="3">
			<span>${ pedido.cliente.nome_cliente } - CPF ${ pedido.cliente.cpf_cliente }<br /><!--------------------------- Nome e CPF do Cliente	-->
			${ pedido.cliente.endereco_cliente }, ${ pedido.cliente.numero_cliente } - ${ pedido.cliente.complemento_cliente } ${ pedido.cliente.cidade_cliente } - ${ pedido.cliente.estado_cliente }<br />&nbsp;</span><!-------------------- Endereço Número e complemento	-->
		</td>
	  </tr>
	  <tr>
		<td>&nbsp;</td>
	...
	<hr /><h1>Bradesco | 237-2 |</h1><h2>${ pedido.numero_pedido }</h2>
	<table class="tab ficha">
	  ...
	  <tr>
		...
		<td>(=) Valor do Documento<br /><span class="vV lD"><fmt:formatNumber value="${ pedido.preco_pedido }" type="currency"/></span></td><!--OK-------------------------- Valor Total	-->
	  </tr>
	  <tr>
	  ...
	  <tr>
		<td>Data do Documento<br /><span class="lD">${ pedido.data_pedido }</span></td><!----OK---------------------------------- Data Gerada	-->
	  </tr>
	  <tr>
	    <td>Data do Processamento<br /><span class="lD">${ pedido.data_pedido }</span></td><!----OK-------------------------------- Data Gerada	-->
	  </tr>
	</table>
