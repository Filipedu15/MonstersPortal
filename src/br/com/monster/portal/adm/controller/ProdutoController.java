...
public class ProdutoController {
	...
	public String create(@Valid Produto produto, @Valid Imagem imagem, BindingResult result) {
	...
	public String Find(Model model, Produto produto,
		...
		model.addAttribute("produtos", dao.Find(nome_prod, produto));
		model.addAttribute("fornecedores", forc_dao.Read());
		model.addAttribute("categorias", cat_dao.Read());
